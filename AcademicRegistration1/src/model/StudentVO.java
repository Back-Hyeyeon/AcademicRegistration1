...
//		StudentVO suvo = null;
		if(!(obj instanceof StudentVO)) {return false;}
		StudentVO suvo = (StudentVO)obj;
		return suvo.no == this.no && suvo.sd_num.equals(this.sd_num) && suvo.sd_name.equals(this.sd_name);
	}
